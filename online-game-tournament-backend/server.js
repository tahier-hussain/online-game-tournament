...
app.use("/api/offline-tournament", require("./routes/api/offline-tournament"));
app.use("/api/online-tournament", require("./routes/api/online-tournament"));
app.use("/api/participate-tournament", require("./routes/api/participate-tournament"));
